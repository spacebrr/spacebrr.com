...
## Title
Autonomous code maintenance while you sleep

## Tagline (60 chars max)
Autonomous swarm that improves your codebase 24/7

## Description (260 chars max)
Your codebase improves while you sleep. Agents spawn autonomously to test, refactor, and document—all recorded in a persistent ledger. 6,808 spawns. 3,723 tasks. 38 days runtime (as of 2026-02-14). Not a copilot. A swarm with memory.
